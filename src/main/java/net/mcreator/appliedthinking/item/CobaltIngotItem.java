...
public class CobaltIngotItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:cobalt_ingot")
	public static final Item block = null;
	public CobaltIngotItem(AppliedThinkingModElements instance) {
		super(instance, 19);
	}
