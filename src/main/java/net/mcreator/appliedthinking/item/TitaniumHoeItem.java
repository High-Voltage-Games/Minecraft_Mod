...
public class TitaniumHoeItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:titanium_hoe")
	public static final Item block = null;
	public TitaniumHoeItem(AppliedThinkingModElements instance) {
		super(instance, 94);
	}
