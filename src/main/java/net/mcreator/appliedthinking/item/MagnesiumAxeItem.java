...
public class MagnesiumAxeItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:magnesium_axe")
	public static final Item block = null;
	public MagnesiumAxeItem(AppliedThinkingModElements instance) {
		super(instance, 51);
	}
