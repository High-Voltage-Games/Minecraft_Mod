...
public class CobaltPickaxeItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:cobalt_pickaxe")
	public static final Item block = null;
	public CobaltPickaxeItem(AppliedThinkingModElements instance) {
		super(instance, 100);
	}
