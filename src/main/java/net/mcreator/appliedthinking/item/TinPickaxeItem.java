...
public class TinPickaxeItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:tin_pickaxe")
	public static final Item block = null;
	public TinPickaxeItem(AppliedThinkingModElements instance) {
		super(instance, 70);
	}
