...
public class CopperShovelItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:copper_shovel")
	public static final Item block = null;
	public CopperShovelItem(AppliedThinkingModElements instance) {
		super(instance, 83);
	}
