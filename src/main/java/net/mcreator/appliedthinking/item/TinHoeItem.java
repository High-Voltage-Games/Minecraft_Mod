...
public class TinHoeItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:tin_hoe")
	public static final Item block = null;
	public TinHoeItem(AppliedThinkingModElements instance) {
		super(instance, 74);
	}
