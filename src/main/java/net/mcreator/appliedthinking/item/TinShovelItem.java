...
public class TinShovelItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:tin_shovel")
	public static final Item block = null;
	public TinShovelItem(AppliedThinkingModElements instance) {
		super(instance, 73);
	}
