...
public class BoneSwordItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:bone_sword")
	public static final Item block = null;
	public BoneSwordItem(AppliedThinkingModElements instance) {
		super(instance, 152);
	}
