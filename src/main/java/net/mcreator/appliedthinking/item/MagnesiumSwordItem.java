...
public class MagnesiumSwordItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:magnesium_sword")
	public static final Item block = null;
	public MagnesiumSwordItem(AppliedThinkingModElements instance) {
		super(instance, 52);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("magnesium_sword"));
	}
}
