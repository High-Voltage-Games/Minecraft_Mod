...
public class TitaniumAxeItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:titanium_axe")
	public static final Item block = null;
	public TitaniumAxeItem(AppliedThinkingModElements instance) {
		super(instance, 91);
	}
