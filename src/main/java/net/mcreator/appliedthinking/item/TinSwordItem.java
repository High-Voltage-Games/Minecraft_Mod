...
public class TinSwordItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:tin_sword")
	public static final Item block = null;
	public TinSwordItem(AppliedThinkingModElements instance) {
		super(instance, 72);
	}
