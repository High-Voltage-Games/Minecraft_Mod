...
public class BeskarIngotItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:beskar_ingot")
	public static final Item block = null;
	public BeskarIngotItem(AppliedThinkingModElements instance) {
		super(instance, 44);
	}
