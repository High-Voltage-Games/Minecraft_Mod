...
public class TitaniumIngotItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:titanium_ingot")
	public static final Item block = null;
	public TitaniumIngotItem(AppliedThinkingModElements instance) {
		super(instance, 26);
	}
