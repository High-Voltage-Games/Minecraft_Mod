...
public class BoneShovelItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:bone_shovel")
	public static final Item block = null;
	public BoneShovelItem(AppliedThinkingModElements instance) {
		super(instance, 153);
	}
