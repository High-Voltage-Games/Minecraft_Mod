...
public class CopperPickaxeItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:copper_pickaxe")
	public static final Item block = null;
	public CopperPickaxeItem(AppliedThinkingModElements instance) {
		super(instance, 80);
	}
