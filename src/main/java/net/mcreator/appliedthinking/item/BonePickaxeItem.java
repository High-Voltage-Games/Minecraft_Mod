...
public class BonePickaxeItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:bone_pickaxe")
	public static final Item block = null;
	public BonePickaxeItem(AppliedThinkingModElements instance) {
		super(instance, 150);
	}
