...
public class MagnesiumIngotItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:magnesium_ingot")
	public static final Item block = null;
	public MagnesiumIngotItem(AppliedThinkingModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("magnesium_ingot");
		}
