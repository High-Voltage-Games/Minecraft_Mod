...
public class NetheriteIngotItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:netherite_ingot")
	public static final Item block = null;
	public NetheriteIngotItem(AppliedThinkingModElements instance) {
		super(instance, 230);
	}
