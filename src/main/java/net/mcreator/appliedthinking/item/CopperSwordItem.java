...
public class CopperSwordItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:copper_sword")
	public static final Item block = null;
	public CopperSwordItem(AppliedThinkingModElements instance) {
		super(instance, 82);
	}
