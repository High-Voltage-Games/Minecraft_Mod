...
public class TitaniumSwordItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:titanium_sword")
	public static final Item block = null;
	public TitaniumSwordItem(AppliedThinkingModElements instance) {
		super(instance, 92);
	}
