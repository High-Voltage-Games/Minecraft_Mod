...
public class MagnesiumArmorItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:magnesium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("applied_thinking:magnesium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("applied_thinking:magnesium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("applied_thinking:magnesium_armor_boots")
	public static final Item boots = null;
	public MagnesiumArmorItem(AppliedThinkingModElements instance) {
		super(instance, 115);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AppliedThinkingItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "applied_thinking:textures/models/armor/magnesium_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("magnesium_armor_helmet"));
		...
		}.setRegistryName("magnesium_armor_chestplate"));
		...
		}.setRegistryName("magnesium_armor_leggings"));
		...
		}.setRegistryName("magnesium_armor_boots"));
	}
}
