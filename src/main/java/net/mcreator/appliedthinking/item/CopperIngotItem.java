...
public class CopperIngotItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:copper_ingot")
	public static final Item block = null;
	public CopperIngotItem(AppliedThinkingModElements instance) {
		super(instance, 13);
	}
