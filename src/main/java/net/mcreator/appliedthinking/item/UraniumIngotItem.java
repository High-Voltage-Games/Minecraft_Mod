...
public class UraniumIngotItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:uranium_ingot")
	public static final Item block = null;
	public UraniumIngotItem(AppliedThinkingModElements instance) {
		super(instance, 32);
	}
