...
public class TesseractItemItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:tesseract_item")
	public static final Item block = null;
	public TesseractItemItem(AppliedThinkingModElements instance) {
		super(instance, 172);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("tesseract_item");
		}
