...
public class CopperArmorItem extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:copper_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("applied_thinking:copper_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("applied_thinking:copper_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("applied_thinking:copper_armor_boots")
	public static final Item boots = null;
	public CopperArmorItem(AppliedThinkingModElements instance) {
		super(instance, 120);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(AppliedThinkingItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "applied_thinking:textures/models/armor/copper_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
