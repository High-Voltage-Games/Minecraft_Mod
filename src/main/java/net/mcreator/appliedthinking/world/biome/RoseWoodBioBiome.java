...
public class RoseWoodBioBiome extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:rose_wood_bio")
	public static final CustomBiome biome = null;
	public RoseWoodBioBiome(AppliedThinkingModElements instance) {
		super(instance, 192);
	}
