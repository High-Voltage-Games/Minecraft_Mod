...
public class GreenConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:green_concreate_wall")
	public static final Block block = null;
	public GreenConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 249);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("green_concreate_wall");
		}
