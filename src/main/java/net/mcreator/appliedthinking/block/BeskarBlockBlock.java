...
public class BeskarBlockBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:beskar_block")
	public static final Block block = null;
	public BeskarBlockBlock(AppliedThinkingModElements instance) {
		super(instance, 46);
	}
