...
public class NetheriteBlockBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:netherite_block")
	public static final Block block = null;
	public NetheriteBlockBlock(AppliedThinkingModElements instance) {
		super(instance, 196);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(50f, 50f).lightValue(0));
