...
public class RoseWoodFenceGateBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:rose_wood_fence_gate")
	public static final Block block = null;
	public RoseWoodFenceGateBlock(AppliedThinkingModElements instance) {
		super(instance, 180);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("rose_wood_fence_gate");
		}
