...
public class PinkConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:pink_concrete_slab")
	public static final Block block = null;
	public PinkConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 222);
	}
