...
public class BrownConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:brown_concreate_wall")
	public static final Block block = null;
	public BrownConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 243);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("brown_concreate_wall");
		}
