...
public class UraniumBlockBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:uranium_block")
	public static final Block block = null;
	public UraniumBlockBlock(AppliedThinkingModElements instance) {
		super(instance, 34);
	}
