...
public class RoseWoodWoodBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:rose_wood_wood")
	public static final Block block = null;
	public RoseWoodWoodBlock(AppliedThinkingModElements instance) {
		super(instance, 173);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rose_wood_wood");
		}
