...
public class SmithingTableBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:smithing_table")
	public static final Block block = null;
	public SmithingTableBlock(AppliedThinkingModElements instance) {
		super(instance, 257);
	}
