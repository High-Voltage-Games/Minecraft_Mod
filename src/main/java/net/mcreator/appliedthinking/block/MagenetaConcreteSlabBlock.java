...
public class MagenetaConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:mageneta_concrete_slab")
	public static final Block block = null;
	public MagenetaConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 224);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("mageneta_concrete_slab");
		}
