...
public class LimeConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:lime_concrete_slab")
	public static final Block block = null;
	public LimeConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 226);
	}
