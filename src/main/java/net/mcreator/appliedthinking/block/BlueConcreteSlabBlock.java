...
public class BlueConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:blue_concrete_slab")
	public static final Block block = null;
	public BlueConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 217);
	}
