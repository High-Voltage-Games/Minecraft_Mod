...
public class TestDoorBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:test_door")
	public static final Block block = null;
	public TestDoorBlock(AppliedThinkingModElements instance) {
		super(instance, 189);
	}
