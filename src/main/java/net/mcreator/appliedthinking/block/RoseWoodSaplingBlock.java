...
public class RoseWoodSaplingBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:rose_wood_sapling")
	public static final Block block = null;
	public RoseWoodSaplingBlock(AppliedThinkingModElements instance) {
		super(instance, 194);
	}
