...
public class WhiteConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:white_concrete_slab")
	public static final Block block = null;
	public WhiteConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 198);
	}
