...
public class YellowConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:yellow_concrete_slab")
	public static final Block block = null;
	public YellowConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 220);
	}
