...
public class BlackConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:black_concrete_slab")
	public static final Block block = null;
	public BlackConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 214);
	}
