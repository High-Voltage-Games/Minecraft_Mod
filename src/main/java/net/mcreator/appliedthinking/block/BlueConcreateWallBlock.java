...
public class BlueConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:blue_concreate_wall")
	public static final Block block = null;
	public BlueConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 241);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_concreate_wall");
		}
