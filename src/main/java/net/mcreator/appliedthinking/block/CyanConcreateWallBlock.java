...
public class CyanConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:cyan_concreate_wall")
	public static final Block block = null;
	public CyanConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 240);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("cyan_concreate_wall");
		}
