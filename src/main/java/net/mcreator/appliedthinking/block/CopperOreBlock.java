...
import net.mcreator.appliedthinking.item.CopperIngotItem;
...
public class CopperOreBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(AppliedThinkingModElements instance) {
		super(instance, 14);
	}
