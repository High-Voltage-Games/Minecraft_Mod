...
public class CyanConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:cyan_concrete_slab")
	public static final Block block = null;
	public CyanConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 216);
	}
