...
public class YellowConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:yellow_concrete_stairs")
	public static final Block block = null;
	public YellowConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 205);
	}
