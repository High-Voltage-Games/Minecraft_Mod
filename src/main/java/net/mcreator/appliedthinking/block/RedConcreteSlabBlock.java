...
public class RedConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:red_concrete_slab")
	public static final Block block = null;
	public RedConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 215);
	}
