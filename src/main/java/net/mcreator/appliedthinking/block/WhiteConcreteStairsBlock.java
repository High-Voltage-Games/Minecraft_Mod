...
public class WhiteConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:white_concrete_stairs")
	public static final Block block = null;
	public WhiteConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 197);
	}
