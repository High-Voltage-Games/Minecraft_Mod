...
public class RoseWoodPlanksBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:rose_wood_planks")
	public static final Block block = null;
	public RoseWoodPlanksBlock(AppliedThinkingModElements instance) {
		super(instance, 175);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rose_wood_planks");
		}
