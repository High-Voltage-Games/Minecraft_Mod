...
public class YellowConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:yellow_concreate_wall")
	public static final Block block = null;
	public YellowConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 244);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_concreate_wall");
		}
