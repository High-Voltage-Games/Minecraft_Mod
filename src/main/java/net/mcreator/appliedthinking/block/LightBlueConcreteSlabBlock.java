...
public class LightBlueConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:light_blue_concrete_slab")
	public static final Block block = null;
	public LightBlueConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 218);
	}
