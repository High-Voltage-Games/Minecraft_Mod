...
public class RedConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:red_concrete_stairs")
	public static final Block block = null;
	public RedConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 200);
	}
