...
import net.mcreator.appliedthinking.item.LithiumIngotItem;
...
public class LithiumOreBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:lithium_ore")
	public static final Block block = null;
	public LithiumOreBlock(AppliedThinkingModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(LithiumIngotItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("lithium_ore", "lithium_ore", blockAt -> {
