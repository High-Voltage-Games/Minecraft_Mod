...
public class RoseWoodSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:rose_wood_slab")
	public static final Block block = null;
	public RoseWoodSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 178);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("rose_wood_slab");
		}
