...
import net.mcreator.appliedthinking.item.MagnesiumIngotItem;
...
public class MagnesiumOreBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:magnesium_ore")
	public static final Block block = null;
	public MagnesiumOreBlock(AppliedThinkingModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MagnesiumIngotItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("magnesium_ore", "magnesium_ore", blockAt -> {
