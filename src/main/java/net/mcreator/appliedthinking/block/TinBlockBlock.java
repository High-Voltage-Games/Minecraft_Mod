...
public class TinBlockBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:tin_block")
	public static final Block block = null;
	public TinBlockBlock(AppliedThinkingModElements instance) {
		super(instance, 3);
	}
