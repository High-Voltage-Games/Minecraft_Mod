...
public class RoseWoodFenceBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:rose_wood_fence")
	public static final Block block = null;
	public RoseWoodFenceBlock(AppliedThinkingModElements instance) {
		super(instance, 179);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("rose_wood_fence");
		}
