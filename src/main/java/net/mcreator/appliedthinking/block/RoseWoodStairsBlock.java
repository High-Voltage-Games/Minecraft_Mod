...
public class RoseWoodStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:rose_wood_stairs")
	public static final Block block = null;
	public RoseWoodStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 177);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("rose_wood_stairs");
		}
