...
import net.mcreator.appliedthinking.item.TitaniumIngotItem;
...
public class TitaniumOreBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:titanium_ore")
	public static final Block block = null;
	public TitaniumOreBlock(AppliedThinkingModElements instance) {
		super(instance, 27);
	}
