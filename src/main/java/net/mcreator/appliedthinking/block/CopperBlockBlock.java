...
public class CopperBlockBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:copper_block")
	public static final Block block = null;
	public CopperBlockBlock(AppliedThinkingModElements instance) {
		super(instance, 15);
	}
