...
public class GrayConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:gray_concrete_slab")
	public static final Block block = null;
	public GrayConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 227);
	}
