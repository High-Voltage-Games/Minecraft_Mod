...
public class PurpleConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:purple_concrete_slab")
	public static final Block block = null;
	public PurpleConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 221);
	}
