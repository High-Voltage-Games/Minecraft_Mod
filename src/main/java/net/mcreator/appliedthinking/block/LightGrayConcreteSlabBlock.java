...
public class LightGrayConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:light_gray_concrete_slab")
	public static final Block block = null;
	public LightGrayConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 228);
	}
