...
public class GrayConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:gray_concreate_wall")
	public static final Block block = null;
	public GrayConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 251);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("gray_concreate_wall");
		}
