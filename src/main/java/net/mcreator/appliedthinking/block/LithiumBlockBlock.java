...
public class LithiumBlockBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:lithium_block")
	public static final Block block = null;
	public LithiumBlockBlock(AppliedThinkingModElements instance) {
		super(instance, 40);
	}
