...
public class PinkConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:pink_concrete_stairs")
	public static final Block block = null;
	public PinkConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 207);
	}
