...
public class GreenConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:green_concrete_slab")
	public static final Block block = null;
	public GreenConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 225);
	}
