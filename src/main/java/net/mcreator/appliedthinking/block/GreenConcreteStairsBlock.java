...
public class GreenConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:green_concrete_stairs")
	public static final Block block = null;
	public GreenConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 210);
	}
