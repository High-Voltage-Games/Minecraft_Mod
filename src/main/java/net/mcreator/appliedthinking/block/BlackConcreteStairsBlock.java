...
public class BlackConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:black_concrete_stairs")
	public static final Block block = null;
	public BlackConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 199);
	}
