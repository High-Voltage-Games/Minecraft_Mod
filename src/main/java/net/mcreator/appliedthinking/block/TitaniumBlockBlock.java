...
public class TitaniumBlockBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:titanium_block")
	public static final Block block = null;
	public TitaniumBlockBlock(AppliedThinkingModElements instance) {
		super(instance, 28);
	}
