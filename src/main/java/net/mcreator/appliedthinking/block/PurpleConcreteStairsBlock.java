...
public class PurpleConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:purple_concrete_stairs")
	public static final Block block = null;
	public PurpleConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 206);
	}
