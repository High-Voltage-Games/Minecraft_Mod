...
public class SearedBrickSlabsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:seared_brick_slabs")
	public static final Block block = null;
	public SearedBrickSlabsBlock(AppliedThinkingModElements instance) {
		super(instance, 268);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("seared_brick_slabs");
		}
