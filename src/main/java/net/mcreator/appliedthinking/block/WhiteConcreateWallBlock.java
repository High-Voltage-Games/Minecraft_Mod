...
public class WhiteConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:white_concreate_wall")
	public static final Block block = null;
	public WhiteConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 237);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("white_concreate_wall");
		}
