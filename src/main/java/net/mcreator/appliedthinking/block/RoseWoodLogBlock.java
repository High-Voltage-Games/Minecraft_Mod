...
public class RoseWoodLogBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:rose_wood_log")
	public static final Block block = null;
	public RoseWoodLogBlock(AppliedThinkingModElements instance) {
		super(instance, 174);
	}
