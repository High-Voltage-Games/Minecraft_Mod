...
public class LightGrayConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:light_gray_concrete_stairs")
	public static final Block block = null;
	public LightGrayConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 213);
	}
