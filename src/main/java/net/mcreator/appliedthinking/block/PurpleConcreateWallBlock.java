...
public class PurpleConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:purple_concreate_wall")
	public static final Block block = null;
	public PurpleConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 245);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_concreate_wall");
		}
