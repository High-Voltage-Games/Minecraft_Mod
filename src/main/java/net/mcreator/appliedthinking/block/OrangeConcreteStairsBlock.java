...
public class OrangeConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:orange_concrete_stairs")
	public static final Block block = null;
	public OrangeConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 208);
	}
