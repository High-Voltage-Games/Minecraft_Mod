...
public class LightGrayConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:light_gray_concreate_wall")
	public static final Block block = null;
	public LightGrayConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 252);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("light_gray_concreate_wall");
		}
