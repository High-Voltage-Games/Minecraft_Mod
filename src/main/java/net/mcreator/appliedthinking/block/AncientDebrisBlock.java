...
public class AncientDebrisBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:ancient_debris")
	public static final Block block = null;
	public AncientDebrisBlock(AppliedThinkingModElements instance) {
		super(instance, 195);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(30f, 30f).lightValue(0).harvestLevel(1)
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 3)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(2, 1, 1, 15))));
		}
	}
}
