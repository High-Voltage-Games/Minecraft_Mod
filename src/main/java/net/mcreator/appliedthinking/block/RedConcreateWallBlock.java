...
public class RedConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:red_concreate_wall")
	public static final Block block = null;
	public RedConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 239);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("red_concreate_wall");
		}
