...
public class OrangeConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:orange_concrete_slab")
	public static final Block block = null;
	public OrangeConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 223);
	}
