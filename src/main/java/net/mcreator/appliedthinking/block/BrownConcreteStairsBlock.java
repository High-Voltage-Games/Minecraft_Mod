...
public class BrownConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:brown_concrete_stairs")
	public static final Block block = null;
	public BrownConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 204);
	}
