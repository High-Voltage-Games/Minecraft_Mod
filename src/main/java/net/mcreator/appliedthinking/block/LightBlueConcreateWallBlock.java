...
public class LightBlueConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:light_blue_concreate_wall")
	public static final Block block = null;
	public LightBlueConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 242);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("light_blue_concreate_wall");
		}
