...
public class CyanConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:cyan_concrete_stairs")
	public static final Block block = null;
	public CyanConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 201);
	}
