...
public class GrayConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:gray_concrete_stairs")
	public static final Block block = null;
	public GrayConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 212);
	}
