...
import net.mcreator.appliedthinking.gui.BeskarForgeGUIGui;
...
public class BeskarForgeBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:beskar_forge")
	public static final Block block = null;
	public BeskarForgeBlock(AppliedThinkingModElements instance) {
		super(instance, 190);
	}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Beskar Forge");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new BeskarForgeGUIGui.GuiContainerMod(id, inventory,
