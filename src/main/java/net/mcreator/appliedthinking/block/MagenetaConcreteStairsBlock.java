...
public class MagenetaConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:mageneta_concrete_stairs")
	public static final Block block = null;
	public MagenetaConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 209);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mageneta_concrete_stairs");
		}
