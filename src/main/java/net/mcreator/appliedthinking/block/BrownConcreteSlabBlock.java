...
public class BrownConcreteSlabBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:brown_concrete_slab")
	public static final Block block = null;
	public BrownConcreteSlabBlock(AppliedThinkingModElements instance) {
		super(instance, 219);
	}
