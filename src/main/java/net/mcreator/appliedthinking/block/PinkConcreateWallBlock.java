...
public class PinkConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:pink_concreate_wall")
	public static final Block block = null;
	public PinkConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 246);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("pink_concreate_wall");
		}
