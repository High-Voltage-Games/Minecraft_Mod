...
public class LimeConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:lime_concrete_stairs")
	public static final Block block = null;
	public LimeConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 211);
	}
