...
public class MagenetaConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:mageneta_concreate_wall")
	public static final Block block = null;
	public MagenetaConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 248);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("mageneta_concreate_wall");
		}
