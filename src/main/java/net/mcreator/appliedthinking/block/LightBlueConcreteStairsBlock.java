...
public class LightBlueConcreteStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:light_blue_concrete_stairs")
	public static final Block block = null;
	public LightBlueConcreteStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 203);
	}
