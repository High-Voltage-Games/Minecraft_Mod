...
public class LimeConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:lime_concreate_wall")
	public static final Block block = null;
	public LimeConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 250);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("lime_concreate_wall");
		}
