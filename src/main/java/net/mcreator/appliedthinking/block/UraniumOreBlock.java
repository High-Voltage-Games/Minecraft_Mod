...
import net.mcreator.appliedthinking.item.UraniumIngotItem;
...
public class UraniumOreBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:uranium_ore")
	public static final Block block = null;
	public UraniumOreBlock(AppliedThinkingModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(UraniumIngotItem.block, (int) (1)));
		}
	}
	@Override
