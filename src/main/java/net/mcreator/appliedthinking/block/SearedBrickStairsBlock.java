...
public class SearedBrickStairsBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:seared_brick_stairs")
	public static final Block block = null;
	public SearedBrickStairsBlock(AppliedThinkingModElements instance) {
		super(instance, 267);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("seared_brick_stairs");
		}
