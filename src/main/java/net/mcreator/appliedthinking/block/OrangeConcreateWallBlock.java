...
public class OrangeConcreateWallBlock extends AppliedThinkingModElements.ModElement {
	@ObjectHolder("applied_thinking:orange_concreate_wall")
	public static final Block block = null;
	public OrangeConcreateWallBlock(AppliedThinkingModElements instance) {
		super(instance, 247);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_concreate_wall");
		}
